...
public:
	...
	// 写日志
    void writeLog(const std::string &info, common_log::Log_Level logLevel = common_log::Log_Level_Info);
...
private:
    const std::string			mDefaultConfig = "config/CameraDetect.conf";
	...
	std::string					mConfieFileText = \
        ...
        "log4cplus.appender.ALL_MSGS.File=logs/CameraDetect.log\n"
        ...
        "log4cplus.appender.ERROR_MSGS.File=logs/CameraDetect.error\n"
